...
export default function BoatsForSaleIntro() {
    return (
        <>
            ...
            <Typography variant="body1">
            Interested in a boat? Use the contact button and your message will reach the owner.</Typography>
            <Typography variant="body1">
                Click the check box on the bottom right of one or more boats and then turn on the 'Only My Marked Boats' switch to see your short-list.
                Save this list to a personal fleet so you can come back later.
            </Typography>
            <Typography variant="body1">
