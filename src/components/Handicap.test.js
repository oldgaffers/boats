...
test('Robinetta foretriangle_area', () => {
  ...
  test('Transcur fMR', () => {
    expect(fMR(boatm2f(Transcur))).toEqual(27.876288659793808);
  });
  
  test('Transcur fR', () => {
    expect(fR(boatm2f(Transcur))).toEqual(27.04);
  });
